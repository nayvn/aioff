...
| 장비 | 무기·방어구·장신구·룬 23슬롯. 항목을 누르면 기본 옵션 / 조율 / 마석 / 신석 상세 |
| 아르카나 | 아르카나 10슬롯. 기본 옵션 / 스킬 옵션 / 세트 효과 |
| 데바니온 | 보드 8종 개방률, 보드를 누르면 15×15 노드 배치와 개방 효과 |
| 스킬 | 액티브 / 패시브 / DP, 장착 스킬은 ★ 표시 |

아르카나 일부(성배·양피지·나침반·종·거울·천칭)는 `mainStats` 가 1~2개뿐이고
능력 대부분이 `subSkills` 에 들어 있다. 둘 다 그려야 정보가 빠지지 않는다.
